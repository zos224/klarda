...
const ModalAddMemberConsortium = ({isOpen, onClose, data, role}) => {
    ...
    useEffect(() => {   
        if (data) {
            setperson({
                ...
                avatar: data.avatar,
                workAt: data.workAt,
                role: data.role ? data.role : role[0],
    ...
    const uploadImage = async (e) => {
        ...
        if (e.target.files && e.target.files[0]) {
            ...
            if (imageAccept.includes(fileExtension)) {
                ...
                setperson({...person, avatar: data.url})
            }
            else {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (person.name === '' || person.avatar == "" || person.role === '' || person.workAt === '' || person.academicTitle === '') {
                    ...
                    <div className="p-6 text-center">
                        <div class="px-4 lg:px-10 py-10 w-full ">
                            ...
                            <div class="w-full px-4 mx-auto">
                                ...
                                <input value={person.workAt} type="text" onChange={(e) => {setperson({...person, workAt: e.target.value})}}  className="border-0 px-3 py-3 placeholder-bodydark2 text-black dark:bg-bodydark bg-white rounded text-sm shadow-4 focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                </div>
                            </div>
                            <div class="w-full px-4 mx-auto">
                                <div class="relative w-full mb-3">
                            ...
                            <div class="w-full px-4 mx-auto">
                                ...
                                <input value={person.website} type="text" onChange={(e) => {setperson({...person, website: e.target.value})}}  className="border-0 px-3 py-3 placeholder-bodydark2 text-black dark:bg-bodydark bg-white rounded text-sm shadow-4 focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                </div>
                            </div>
                            <div>
...
export default ModalAddMemberConsortium