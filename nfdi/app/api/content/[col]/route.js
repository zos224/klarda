...
export const GET = async (req, { params }) => {
    ...
    const validColumns = ["home", 'aims', 'consortium', "taskArea", "contact", "about", "newPP", "coop"]; // Cập nhật danh sách này với các cột hợp lệ.
    ...
    try {
        const data = await prisma.Content.findFirst({ select });
        return new Response(JSON.stringify(data), { status: 200 });
    } catch (error) {
